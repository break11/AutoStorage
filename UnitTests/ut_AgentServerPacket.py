...
class TestAgentServerPacket(unittest.TestCase):
    ...
    def test_fromBStr(self):
        ...
        p1 = CAgentServerPacket.fromBStr( b"039,002,1,00026caf:@ER:*111:222:333" )
        p2 = b"039,002,1,00026caf:@ER:*111:222:333\n"
        ...
        # test Text Message
        p1 = CAgentServerPacket.fromBStr( b"039,002,1,00026caf:@TX:Global Power Select to SUPERCAP" )
        p2 = b"039,002,1,00026caf:@TX:Global Power Select to SUPERCAP\n"
        ...
        p1 = CAgentServerPacket.fromBStr( b"011,003,2,00023eee:@WR:#Warning" )
        p2 = b"011,003,2,00023eee:@WR:#Warning\n"
        ...
        # test Error Message
        p1 = CAgentServerPacket.fromBStr( b"011,003,2,00034fff:@ER:*Error" )
        p2 = b"011,003,2,00034fff:@ER:*Error\n"
        ...
        p1 = CAgentServerPacket.fromBStr( b"000,000:@HW\n" )
        p2 = b"000,000:@HW\n"
        p3 = b"000,000:@HW"
        ...
        print( p1.toBStr( appendLF=False ), p3 )
        self.assertEqual( p1.toBStr( appendLF=False ), p3 )
        ###################################################
        ...
        p2 = CAgentServerPacket.fromBStr( b" 11, 55,1,0000000a:@HW: 17" )
        ...
        pNone = CAgentServerPacket.fromBStr( b"Not supported cmd - 'COLON' symbol not present!" )
        print( pNone, "None" )
        self.assertEqual( pNone, None )

        pNone = CAgentServerPacket.fromBStr( b"AAA,BBB:@HW" )
        print( pNone, "None" )
        self.assertEqual( pNone, None )
        # @HW
        ###################################################
        p1 = CAgentServerPacket( event=EAgentServer_Event.HelloWorld, packetN=0 )
        p2 = CAgentServerPacket.fromBStr( b"000,000:@HW" )
        p3 = b"000,000:@HW\n"

        print( p1.toBStr(), p2.toBStr(), p3 )
        self.assertEqual( p1.toBStr(), p2.toBStr() )
        self.assertEqual( p1.toBStr(), p3 )
        ###################
        p1 = CAgentServerPacket( event=EAgentServer_Event.HelloWorld, agentN=555, packetN=11, channelN=1, timeStamp=int("0xA", 16), data="000" )
        p2 = CAgentServerPacket.fromBStr( b"011,555,1,0000000a:@HW:000" )
        ...
        p2 = CAgentServerPacket.fromBStr( b"023:@AC" )
        p3 = b"023:@AC\n"
        ...
        p2 = CAgentServerPacket.fromBStr( b"051,555:@BS" )
        p3 = b"051,555:@BS\n"
        ...
        p2 = CAgentServerPacket.fromBStr( b"035,777,2,00000020:@BS:S,43.2V,39.31V,47.43V,-0.06A" )
        ...
        p2 = CAgentServerPacket.fromBStr( b"020,555:@TS" )
        p3 = b"020,555:@TS\n"
        ...
        p2 = CAgentServerPacket.fromBStr( b"002,002,1,00025fdc:@TS:22,23,22,24,24,25,25,25,25" )
        ...
        p2 = CAgentServerPacket.fromBStr( b"040,022:@TL" )
        p3 = b"040,022:@TL\n"
        ...
        p2 = CAgentServerPacket.fromBStr( b"040,215,1,0000aabb:@TL:035" )
        ...
        p2 = CAgentServerPacket.fromBStr( b"040,022:@WO" )
        p3 = b"040,022:@WO\n"
        ...
        p2 = CAgentServerPacket.fromBStr( b"040,215,1,0000aabb:@NT:DP" )
        ...
        p2 = CAgentServerPacket.fromStr( "001,001:@SB" )
        p3 = b"001,001:@SB\n"
        ...
        p2 = CAgentServerPacket.fromBStr( b"040,215,1,0000aabb:@OP:50" )
        ...
        p2 = CAgentServerPacket.fromBStr( b"040,215,1,0000aabb:@OD:50" )
