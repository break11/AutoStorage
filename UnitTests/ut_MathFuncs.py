...
class TestMathFuncs(unittest.TestCase):
    ...
    def test_shortestNodesRoute(self):
        ...
        test_nodes_route = gu.shortestNodesRoute( nxGraph_mag_ext, startNode = "26", targetNode = "40", agentAngle = 90.0, targetSide = None )
        self.assertEqual ( nodes_route, test_nodes_route )
        
        test_nodes_route = gu.shortestNodesRoute( nxGraph_mag_ext, startNode = "26", targetNode = "40", agentAngle = 270.0, targetSide = None )
        self.assertEqual ( nodes_route, test_nodes_route )

        test_nodes_route = gu.shortestNodesRoute( nxGraph_mag_ext, startNode = "26", targetNode = "40", agentAngle = 90.0, targetSide = SGT.ESide.Right )
        self.assertEqual ( nodes_route, test_nodes_route )

        test_nodes_route = gu.shortestNodesRoute( nxGraph_mag_ext, startNode = "26", targetNode = "40", agentAngle = 270.0, targetSide = SGT.ESide.Left )
        self.assertEqual ( nodes_route, test_nodes_route )
        ...
        test_nodes_route = gu.shortestNodesRoute( nxGraph_mag_ext, startNode = "26", targetNode = "40", agentAngle = 90.0, targetSide = SGT.ESide.Left )
        self.assertEqual ( nodes_route, test_nodes_route )

        test_nodes_route = gu.shortestNodesRoute( nxGraph_mag_ext, startNode = "26", targetNode = "40", agentAngle = 270.0, targetSide = SGT.ESide.Right )
        self.assertEqual ( nodes_route, test_nodes_route )
        ...
        test_nodes_route = gu.shortestNodesRoute( nxGraph_mag_ext, startNode = "25", targetNode = "40", agentAngle = 90.0, targetSide = SGT.ESide.Left )
        self.assertEqual ( nodes_route, test_nodes_route )

        test_nodes_route = gu.shortestNodesRoute( nxGraph_mag_ext, startNode = "25", targetNode = "40", agentAngle = 270.0, targetSide = SGT.ESide.Right )
        self.assertEqual ( nodes_route, test_nodes_route )

        # case 2
        nodes_route = ["19", "18", "17", "16", "24", "25", "23", "22", "21", "20", "29", "30", "31", "34", "35", "36", "37", "38", "39", "40"]

        test_nodes_route = gu.shortestNodesRoute( nxGraph_mag_ext, startNode = "19", targetNode = "40", agentAngle = 0.0, targetSide = SGT.ESide.Left )
        self.assertEqual ( nodes_route, test_nodes_route )

        test_nodes_route = gu.shortestNodesRoute( nxGraph_mag_ext, startNode = "19", targetNode = "40", agentAngle = 180.0, targetSide = SGT.ESide.Right )
        self.assertEqual ( nodes_route, test_nodes_route )
        ...
        test_nodes_route = gu.shortestNodesRoute( nxGraph_mag_ext, startNode = "20", targetNode = "40", agentAngle = 180.0, targetSide = SGT.ESide.Left )
        self.assertEqual ( nodes_route, test_nodes_route )

        test_nodes_route = gu.shortestNodesRoute( nxGraph_mag_ext, startNode = "20", targetNode = "40", agentAngle = 0.0, targetSide = SGT.ESide.Right )
        self.assertEqual ( nodes_route, test_nodes_route )
        ...
        test_nodes_route = gu.shortestNodesRoute( nxGraph_mag_ext, startNode = "20", targetNode = "40", agentAngle = 0.0, targetSide = SGT.ESide.Left )
        self.assertIn ( test_nodes_route, [ nodes_route_1, nodes_route_2 ] )

        test_nodes_route = gu.shortestNodesRoute( nxGraph_mag_ext, startNode = "20", targetNode = "40", agentAngle = 180.0, targetSide = SGT.ESide.Right )
        self.assertIn ( test_nodes_route, [ nodes_route_1, nodes_route_2 ] )
        ...
        test_nodes_route = gu.shortestNodesRoute( nxGraph_mag_ext, startNode = "44", targetNode = "40", agentAngle = 0.0, targetSide = SGT.ESide.Left )
        self.assertIn ( test_nodes_route, [ nodes_route_1, nodes_route_2 ] )

        test_nodes_route = gu.shortestNodesRoute( nxGraph_mag_ext, startNode = "44", targetNode = "40", agentAngle = 180.0, targetSide = SGT.ESide.Right )
        self.assertIn ( test_nodes_route, [ nodes_route_1, nodes_route_2 ] )
        ...
        test_nodes_route = gu.shortestNodesRoute( nxGraph_mag_ext, startNode = "29", targetNode = "29", agentAngle = 0.0, targetSide = SGT.ESide.Left )
        self.assertIn ( test_nodes_route, [ nodes_route_1, nodes_route_2 ] )

        test_nodes_route = gu.shortestNodesRoute( nxGraph_mag_ext, startNode = "29", targetNode = "29", agentAngle = 180.0, targetSide = SGT.ESide.Right )
        self.assertIn ( test_nodes_route, [ nodes_route_1, nodes_route_2 ] )
        ...
        test_nodes_route = gu.shortestNodesRoute( nxGraph_mag_ext, startNode = "61", targetNode = "40", agentAngle = 0.0, targetSide = SGT.ESide.Left )
        self.assertIn ( test_nodes_route, [ nodes_route_1, nodes_route_2 ] )

        test_nodes_route = gu.shortestNodesRoute( nxGraph_mag_ext, startNode = "61", targetNode = "40", agentAngle = 180.0, targetSide = SGT.ESide.Right )
        self.assertIn ( test_nodes_route, [ nodes_route_1, nodes_route_2 ] )

        ################## Стартовая и целевая ноды совпадают, разворот не требуется #####################################
        nodes_route = ["29"]

        test_nodes_route = gu.shortestNodesRoute( nxGraph_mag_ext, startNode = "29", targetNode = "29", agentAngle = 0.0, targetSide = SGT.ESide.Right )
        self.assertEqual ( test_nodes_route, nodes_route )

        test_nodes_route = gu.shortestNodesRoute( nxGraph_mag_ext, startNode = "29", targetNode = "29", agentAngle = 180.0, targetSide = SGT.ESide.Left )
        self.assertEqual ( test_nodes_route, nodes_route )
        ...
        test_nodes_route = gu.shortestNodesRoute( nxGraph_mag_ext, startNode = "40", targetNode = "40", agentAngle = 0.0, targetSide = SGT.ESide.Left )
        self.assertIn ( test_nodes_route, [ nodes_route_1, nodes_route_2 ] )

        test_nodes_route = gu.shortestNodesRoute( nxGraph_mag_ext, startNode = "40", targetNode = "40", agentAngle = 180.0, targetSide = SGT.ESide.Right )
        self.assertIn ( test_nodes_route, [ nodes_route_1, nodes_route_2 ] )
        ...
        test_nodes_route = gu.shortestNodesRoute( nxGraph_mag_ext, startNode = "83", targetNode = "40", agentAngle = 0.0, targetSide = SGT.ESide.Left )
        self.assertEqual ( test_nodes_route, nodes_route )

        test_nodes_route = gu.shortestNodesRoute( nxGraph_mag_ext, startNode = "83", targetNode = "40", agentAngle = 180.0, targetSide = SGT.ESide.Right )
        self.assertEqual ( test_nodes_route, nodes_route )
