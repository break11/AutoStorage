...
cmdProps = { SAP.cmd_PE   : cmdDesc( event=EV.PowerEnable,    data=None),
             ...
             SAP.cmd_BL_L : cmdDesc( event=EV.BoxLoad,        data=SGT.ESide.Left.shortName()  ),
             SAP.cmd_BL_R : cmdDesc( event=EV.BoxLoad,        data=SGT.ESide.Right.shortName() ),
             SAP.cmd_BU_L : cmdDesc( event=EV.BoxUnload,      data=SGT.ESide.Left.shortName()  ),
             SAP.cmd_BU_R : cmdDesc( event=EV.BoxUnload,      data=SGT.ESide.Right.shortName() ),
