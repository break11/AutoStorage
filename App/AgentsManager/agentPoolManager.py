...
#         agentLink = CAgentLink(agentN, self.routeBuilder)
#         self.agentLinkPool[ agentN ] = agentLink
#         # self.agentPoolManagerWidget.createNewAgentTab(agentN)

#     def isAgentExist(self, agentN):
#         if agentN in self.agentLinkPool:
#             return True
#         return False

#     def deleteAgent(self, agentN):
#         del self.agentLinkPool[agentN]

#     def getAgent(self, agentN):
#         try:
#             return self.agentLinkPool[ agentN ]
#         except:
#             print( f"WARNING: Agent n={agentN} acess requested but it wasn't created yet." )
